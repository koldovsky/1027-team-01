// const urlWeather = "https://api.openweathermap.org/data/3.0/onecall?lat==49.842957&lon=24.031111&units=metric&appid={ffeddea4bf4039b56dc5181920e48db2}"

// fetch(url)
//     .then(response => response.json())
//     .then(data => {
//         const temperatureInCelsius = data.current.temp;
//         document.querySelector('.').innerText = temperatureInCelsius
//     })
